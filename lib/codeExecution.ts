// Shared Judge0 execution + solution-code wrapping, used by /api/duels and
// /api/practice/submit — both need to take raw user/AI solution code and turn
...
export function wrapWithIO(solutionCode: string, language: string, problem: any): string {
