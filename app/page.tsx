...
const LEVELS = [
    { title: 'Pick a problem', desc: 'Choose from 37+ problems across 10 categories and 3 difficulty levels. New problems added regularly.' },
...
const FEATURES = [
    ...
    { icon: '🗂', title: 'All Problem Categories', desc: 'Arrays, Strings, Trees, Graphs, Dynamic Programming, System Design, Binary Search, Stacks & Queues, Greedy, and Bit Manipulation.', pro: true },
    ...
    return (
        <div className={`${spaceGrotesk.className} landing-page`} style={{ background: 'oklch(16% 0.02 260)', color: 'oklch(96% 0.01 260)', minHeight: '100vh', overflowX: 'hidden', position: 'relative' }}>
            ...
            <section style={{ maxWidth: 700, margin: '0 auto', padding: '20px 48px 90px' }}>
                ...
                {/* Video is 1920x1080. Container is locked to a slightly shorter ratio
                    and the video uses object-fit: cover + object-position: bottom, so
                    it always fills the box completely (no gap) while cropping a sliver
                    off the top. VIDEO_TOP_CROP_PX controls how much. */}
                <div style={{
