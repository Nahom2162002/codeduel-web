...
const LEVELS = [
    { title: 'Pick a problem', desc: 'Choose from 29+ problems across 8 categories and 3 difficulty levels. New problems added regularly.' },
...
const FEATURES = [
    ...
    { icon: '🗂', title: 'All Problem Categories', desc: 'Arrays, Strings, Trees, Graphs, Dynamic Programming, System Design, Binary Search, and Stacks & Queues.', pro: true },
