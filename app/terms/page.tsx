    ...
    return (
        <div className={`${spaceGrotesk.className} app-page`} style={{ background: 'oklch(16% 0.02 260)', color: 'oklch(96% 0.01 260)', minHeight: '100vh' }}>
            ...
            <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 48px', maxWidth: 1280, margin: '0 auto' }}>
                ...
                <Suspense fallback={<span className={jetbrainsMono.className} style={{ color: 'oklch(78% 0.02 260)', fontSize: 14.5 }}>← Back to CodeDuel</span>}>
            ...
            <main style={{ maxWidth: 760, margin: '0 auto', padding: '24px 48px 100px' }}>
                ...
                <section style={{ marginBottom: 36 }}>
                    ...
                    <ul style={UL}>
                        ...
                        <li>Store your submissions as part of your activity history</li>
                    </ul>
                    <p style={P_MB}>Code Review is intended for code you've already written, including code written outside of CodeDuel — from LeetCode, an interview, or your job. You confirm that you have the right to submit any such code for review.</p>
                    <p style={P}>You retain ownership of all code you submit. We do not claim any rights to your solutions and do not use them to train AI models.</p>
                </section>
