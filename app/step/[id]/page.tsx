    ...
    return (
        <div className={`${spaceGrotesk.className} step-page`} style={{
            ...
            <div className="step-columns" style={{ flex: 1, display: 'flex', minHeight: 0 }}>
                <div className="step-problem-panel" style={{ width: '42%', display: 'flex', flexDirection: 'column', minHeight: 0, borderRight: '1px solid oklch(28% 0.02 260)' }}>
                    <div style={{ display: 'flex', gap: 4, padding: '10px 20px 0', borderBottom: '1px solid oklch(28% 0.02 260)', flexShrink: 0 }}>
                        {(['problem', 'result'] as const).map(tab => (
                            ...
                            >
                                {tab === 'problem' ? 'Problem' : `Results${result ? ` (${result.totalScore}/100)` : ''}`}
                            </div>
                        ))}
                    </div>
