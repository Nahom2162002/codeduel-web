...
const CATEGORIES = [
    'all', 'arrays', 'strings', 'trees', 'graphs', 'dynamic-programming', 'system-design', 'binary-search', 'stacks', 'greedy', 'bit-manipulation', 'hash-table', 'two-pointers', 'heap', 'sliding-window', 'matrix', 'sorting', 'union-find', 'topological-sort', 'simulation', 'counting', 'shortest-path', 'number-theory', 'bitmask', 'recursion', 'geometry', 'divide-and-conquer', 'game-theory', 'linked-list', 'trie', 'iterator', 'interactive', 'concurrency', 'queue', 'deque', 'backtracking', 'intervals'
];
            ...
            <nav className="app-nav" style={{
                ...
                <div className="app-nav-left" style={{ display: 'flex', alignItems: 'center', gap: 40 }}>
                    ...
                    <div className="app-nav-links" style={{ display: 'flex', alignItems: 'center', gap: 28, fontSize: 15, fontWeight: 500 }}>
                        ...
                        <Link href="/drills" style={{ color: 'oklch(80% 0.02 260)', textDecoration: 'none' }}>
                            Drills
                        </Link>
                        <Link href="/flashcards" style={{ color: 'oklch(80% 0.02 260)', textDecoration: 'none' }}>
                            Flashcards
                        </Link>
                        <Link href="/review" style={{ color: 'oklch(80% 0.02 260)', textDecoration: 'none' }}>
                            Code Review
                        </Link>
